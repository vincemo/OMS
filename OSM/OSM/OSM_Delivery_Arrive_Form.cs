...
namespace OSM
{
    public partial class OSM_Delivery_Arrive_Form : UserControl
    {
        //父窗口
        ...
        /// 构造函数
        /// </summary>
        public OSM_Delivery_Arrive_Form()
        {
            InitializeComponent();
            ...
            queryFromDiliverySheetV(dataGridView_Delivery, "where DILIVERY_STATE = '2'");
        }
        ...
        {
            string whereString = "where DILIVERY_STATE = '2' ";
        ...
        private void dataGridView_Delivery_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView_Delivery.Columns[e.ColumnIndex].Name == "auditBtn")
            {
                ...
                deliveryArrive(d_sheet_id, order_id);
            }
        }
        ...
        private void deliveryArrive(string d_sheet_id, string order_id)
        {
            //弹出日期选择框
